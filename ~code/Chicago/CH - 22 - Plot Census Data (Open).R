...
grid.arrange(
  # Population
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = TotPop), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  # pWhite
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = pWhite), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  #pFemale
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = pFemale), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  # MdAge
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = MdAge), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
...
grid.arrange(
  # MdHHInc
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = MdHHInc), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  # MedRent
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = MedRent), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  # TotHseUni
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = TotHseUni), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  # MedValue
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = MedValue), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
...
grid.arrange(
  #pDrive
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = pDrive), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  #pTrans
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = pTrans), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
  ...
  #pVehAvai
  ggplot() + 
    geom_sf(data = CH_Census_ct, aes(fill = pVehAvai), color = "white", alpha = 0.8) +
    scale_fill_viridis()+
