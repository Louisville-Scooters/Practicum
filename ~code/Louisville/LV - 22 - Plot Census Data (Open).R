...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Percentage of white by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Percentage of female by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Median age by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Median Household Income by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Median rent by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Total housing units by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Median housing value by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Percentage of people driving to work by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Percentage of people taking public transit to work by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Percentage of people commuting 30mins or more by census tract (2019)") +
  mapTheme(),
...
ggplot() + 
  ...
  scale_fill_viridis()+
  labs(title = "Percentage of people having one or more vehicle available by census tract (2019)") +
  mapTheme(),
