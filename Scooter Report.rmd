...
In this study, we use a combination of open and private dockless scooter usage data from six American cities to construct a model for predicting ridership in ten cities that do not currently have scooter share systems in place. Our model shows that the business-as-usual approach to introducing scooters into a new market is likely to create inequitable access to the vehicles for residents. While cities such as Louisville, KY have recognized these inequities and instituted distribution requirements to address them, we show through analysis of vehicle rebalancing data that providers do not seem to be complying with these requirements, and stronger enforcement may be necessary. Lastly, we introduce a proof-of-concept web application that allows users to explore the spatial distribution of our model’s predictions for each city and compare them to demographic and socioeconomic variables of interest. We believe that this tool will allow policymakers to anticipate the geography of scooter ridership in their cities and understand - and ultimately plan for - the inequities created by the business-as-usual approach to launching and administering scooter share systems.
...
data_info <- data.frame(City = c("Louisville", "Washington, DC", "Austin", "Minneapolis", "Kansas City", "Chicago"),
                        ...
                        TimePeriodAvailable = c("Nov. 2018 - Dec. 2019", "", "", "May 2019 - Sept. 2019", "June 2019 - Dec. 2019", "June 2019 - Sept. 2019"),
                        TemporalPrecision = c("Actual time", "Actual time", "", "30 minutes", "15 minutes", "Hour"),
                        OtherInfo = c("Trip ID\nVehicle ID\nBattery Level", "Trip ID\nVehicle ID\nTrip Distance", "", "Trip ID\nVehicle ID\nTrip Distance", "Trip ID\nVehicle ID\nTrip Distance", "Trip ID\nVehicle ID\nTrip Distance\nCommunity Area Name"),
                        FleetInfo = c("Operator\nRebalancing\nVehicle Maintenance/Retirement/Entry", "Operator", "", "No", "No", "No"),
...
%%[map of Chicago ridership by census tract for July through September]%%

Louisville and DC, on the other hand, provided point data. We aggregated this to the census tract level.

%%[map of Louisville and DC points on top
Map of Louisville and DC census tract aggregation on bottom]%%
...
%%[map showing origins by census tract for each city on left]
[map showing destinations by census tract for each city on right]%%
...
%%[maps showing net flow by census tract for each city]%%
